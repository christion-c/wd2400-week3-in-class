...
// --- Dish Item Renderer ---
const DishItem = ({ dish, bringer }: {dish: any, bringer: any}) => (
...
export default function App() {
  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(dishesCollectionRef, (snapshot: any) => {
      const liveDishes = snapshot.docs.map((doc: any) => ({
        id: doc.id,
        ...doc.data(),
      }));
